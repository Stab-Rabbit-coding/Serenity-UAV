...
- **The ISO7642 → ISO6442 substitution is a valid drop-in:** both are 4-channel,
  **2-forward / 2-reverse**, DW-16, pin-compatible. ✅ (BOM string / `Pilot.md` /
...
sch↔pcb divergence documented for Commo/XO.** The rebuild must therefore be
...
Confirmed 2026-07-13 by inspecting `Pilot.kicad_sch` lib_symbols/instances:
...
- **The schematic is a DP83825I design; the PCB is an ADIN1300 design.** The
  ...
  `Pilot.md`). The PCB instead has `ADIN1300` ×2 + `749010012A` + ISO isolators and
...
confirm the **PCB's** Ethernet front-end is authoritative and **`Pilot.md` §1 is
stale**. `Pilot.md` still documents a DP83825I + HX1188NL + TPS62933 design that
is not on the board. `Pilot.md` §§1–3 need to be rewritten to the as-built
