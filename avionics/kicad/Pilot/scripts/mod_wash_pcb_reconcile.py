#!/usr/bin/env python3
"""Wash PCB repair pass: strip stale routing, reconcile with Wash_rebuild.

Context (2026-07-21): the user re-placed Wash's components to clear
