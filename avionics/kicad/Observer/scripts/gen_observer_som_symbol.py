...
# -*- coding: utf-8 -*-
"""
gen_jayne_som_symbol.py -- author a CLEAN-ROOM KiCad symbol for the PHYTEC
...
(avionics/kicad/Observer/Observer_som_pinmap.csv) and emits an ORIGINAL symbol with our own
functional-bank arrangement -- no SnapEDA geometry, grouping, or coordinates.

Output: avionics/kicad/symbols/Observer_SoM.kicad_sym  (CC BY 4.0, committable).
...
CSV = HERE.parent / "Observer_som_pinmap.csv"
OUT = HERE.parent.parent / "symbols" / "Observer_SoM.kicad_sym"

SYMNAME = "Observer_SoM_phyCORE_AM62A"
