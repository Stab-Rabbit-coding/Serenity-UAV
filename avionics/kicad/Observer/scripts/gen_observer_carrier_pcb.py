...
# -*- coding: utf-8 -*-
"""
gen_Observer_carrier_pcb.py -- rebuild Observer.kicad_pcb in the SoM end-state.
=============================================================================
Drives the PCB from the schematic netlist (exported by kicad-cli from
Observer.kicad_sch, authored by gen_Observer_carrier_sch.py).  Removes the old
...
PLACE = {
    "U_SOM": (OBSERVER, "SOM", "B", (200, 151), 90),
    "U2": (OBSERVER, "KSZ", "F", (198, 150), 0),
    ...
    "T1": (OBSERVER, "XFMR", "F", (180, 160), 0),
    "T2": (OBSERVER, "XFMR", "F", (180, 170), 0),
    ...
    "J_CAM_DS": (OBSERVER, "DS9", "F", (233, 138), 0),
    "J_TOF_DS": (OBSERVER, "DS4", "F", (233, 162), 0),
    "J_LASER_DS": (OBSERVER, "DS2", "F", (236, 165), 0),
