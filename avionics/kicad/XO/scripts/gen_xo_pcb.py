#!/usr/bin/env python3
"""gen_xo_pcb.py — Build the XO PCB from the schematic netlist.

Consumes ``kicads/XO.net`` (``kicad-cli sch export netlist --format
kicadsexpr`` of ``XO.kicad_sch``) and writes ``kicads/XO.kicad_pcb`` with every
...
``gen_xo_footprints.py`` is the header pin field, not the full module body
...
NETLIST = KICADS / "XO.net"
OUT = KICADS / "XO.kicad_pcb"
DRU = KICADS / "XO.kicad_dru"
SYSLIB = Path("/usr/share/kicad/footprints")
CUSTOM = HERE.parent.parent / "Serenity-Custom.pretty"

X0, Y0 = 121.0, 87.5          # board origin (mm), same absolute sheet coords as the legacy XO PCB
BW, BH = 55.0, 35.0           # board size (mm) — XO.md §1 hard constraint
CORNER_R = 3.0
EDGE_KEEP = 0.5
...
ANCHOR_PREFIX = [
    ...
    ("FB-SIK", "SIK"), ("C-SIK", "SIK"), ("R-LORA", "LORA"), ("C-LORA", "LORA"),
    ("C-WIFI", "WIFI"), ("R-WIFI", "WIFI"), ("FB-SDIO", "WIFI"),
    ("C-FLASH", "NOR-FLASH"), ("R-FLASH-WP", "NOR-FLASH"), ("C-PLD", "SD-WB"),
    ("C-1V8", "U-1V8"),
    ("FL-SIK", "J-SMA-SIK"), ("D-ANT-SIK", "J-SMA-SIK"),
    ("FL-LORA", "J-SMA-LORA"), ("D-ANT-LORA", "J-SMA-LORA"),
    ("FL-WIFI", "J-SMA-WIFI"), ("D-ANT-WIFI", "J-SMA-WIFI"),
]
...
DRU_TEXT = """(version 1)
# XO Rev S2 custom DRC rules — generated by gen_xo_pcb.py (CC BY 4.0)
...
def main() -> None:
    ...
    tb.SetComment(0, "PocketBeagle 2 Industrial cape, 55 x 35 mm, 6-layer; generated by gen_xo_pcb.py")
