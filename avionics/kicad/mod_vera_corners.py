...
# -*- coding: utf-8 -*-
"""
mod_vera_corners.py -- Vera nose PCB: fillet the trapezoid corners with arcs
...
Modifies Vera.kicad_pcb in place (GUI-owned board).  Trapezoid corners are the
Rev C outline (docs/VERA_NOSE_TRAPEZOID.md).  Board loads; invalid_outline = 0.
