...
# -*- coding: utf-8 -*-
"""
gen_vera_som_pcm071.py -- CLEAN-ROOM KiCad symbol for the PHYTEC phyCORE-AM62x
CONNECTORIZED module (PCM-071), authored from the PHYTEC hardware manual.
=============================================================================
Vera uses the CONNECTORIZED variant (user decision 2026-07-12): PCM-071, 32x43 mm,
...
(Vera_SoM.kicad_sym 270-pin / vera_som_pinmap.csv) which was the wrong variant.
...
Output: avionics/kicad/symbols/Vera_SoM_PCM071.kicad_sym
...
OUT = SYMDIR / "Vera_SoM_PCM071.kicad_sym"
SYMNAME = "Vera_SoM_PCM071"
# 2x Samtec BTH-060 board-to-board; footprint authored separately from Samtec dims.
FOOTPRINT = "Vera:phyCORE-AM62x_PCM071_2xBTH-060"
BANKS = ["A", "B", "C", "D"]
...
def main():
    ...
    parts = [
        "(kicad_symbol_lib (version 20211014) (generator serenity_vera_cleanroom)",
