...
> can be interfered with or ignored equally."* — Skipper, *Firefly*, "The Train Job" (2002)
...
signature for radio messages Commo transmits and for messages it forwards to/from XO or
...
elsewhere in `Commo.kicad_sch`. An earlier draft of `inject_commo_tpm.py` instead added a
dedicated 6-pin `J_TPM` header (reasoning that cross-*file* net-name reuse, e.g. Pilot's
