...
# -*- coding: utf-8 -*-
"""
cleanup_commo_drc.py — Clear the pre-existing hard DRC debt on Commo.kicad_pcb
============================================================================
The Commo board carried 35 pre-existing "hard" DRC violations (present since
...
here at their source (no violation is merely re-classified/hidden):
  ...
  2. POWER-NETCLASS CLEARANCE (11 of 15) -- handled in Commo.kicad_pro: the POWER
...
PCB_FILE = "kicads/Commo.kicad_pcb"
