...
(tied to both DE and RE_N) is preserved. TACCO's pre-existing ADM2795EBRWZ symbol had
the same incorrectly-numbered-pins defect as Wash's, corrected in the same pass
(`avionics/kicad/fix_wash_zoe_isolators.py`). TACCO's PCB footprint has not yet been
