...
(`avionics/kicad/FlightEngineer/scripts/inject_kaylee_trust_module.py`) as part of the fleet-wide
trust-module rollout, giving FlightEngineer its own TPM-signed presence on both isolated buses
