...
# + SLB9670 TPM + isolated CAN-FD + isolated RS-485). FlightEngineer previously had
...
# FlightEngineer's battery/current telemetry is also TPM-signed and republished on
# both isolated buses, per "bake the trusted can+rs485 interface into flightengineer
...
def gen_sch() -> str:
    ...
    parts.append(
        sym_inst(
            "Conn_JST_GH_02P",
            "J_ALERT",
            "JST-GH SM02B-GHS-TB 2P 1.25mm ALERT to Wash GPIO",
            590,
            65,
        )
    )
    ...
    # +3V3 buck fed from FlightEngineer's existing regulated +5V avionics rail
...
if __name__ == "__main__":
    ...
    # known, not-yet-fixed bug for FlightEngineer specifically ("HERE-relative script
    # paths need an extra .parent after the move; FlightEngineer's own gen scripts
