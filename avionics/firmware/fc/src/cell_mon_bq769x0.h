 ...
 *
 * Drives the Texas Instruments BQ76930PWRQ1 on the Flight Engineer power distribution
 ...
 * On Flight Engineer, CRC mode IS enabled (DFSEL tied appropriately during board
 * layout).
 *
