 ...
 *
 * INA226 I2C address layout on PDB-2 (all on i2c_dev_pdb bus):
 ...
 *
 * Shunt resistor values (see PDB-2.md §INA226 Calibration):
...
/** I2C addresses for ESC current monitors on PDB-2. */
