 ...
 *
 * Integrates the INA226 current monitors on Flight Engineer and the BQ76930 cell
...
/** Number of ESC current channels on Flight Engineer (Phases 5–10; ESC5 is Phase 11). */
 ...
 *
 * @param[in]  i2c_dev_pdb  Path to the I2C bus connected to Flight Engineer monitors
 *                          (e.g. "/dev/i2c-2"; Pilot Shepherd's room / Bay A
 * J_EXT_I2C).
