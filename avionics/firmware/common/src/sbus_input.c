                              ...
                              sbus_frame_t *frame_out)
{
     ...
     */
    frame_out->channels[0]  = ((uint16_t)buf[1]       | ((uint16_t)buf[2]  << 8U)) & 0x07FFU;
    frame_out->channels[1]  = (((uint16_t)buf[2]  >> 3U) | ((uint16_t)buf[3]  << 5U)) & 0x07FFU;
    frame_out->channels[2]  = (((uint16_t)buf[3]  >> 6U) | ((uint16_t)buf[4]  << 2U) | ((uint16_t)buf[5]  << 10U)) & 0x07FFU;
    frame_out->channels[3]  = (((uint16_t)buf[5]  >> 1U) | ((uint16_t)buf[6]  << 7U)) & 0x07FFU;
    frame_out->channels[4]  = (((uint16_t)buf[6]  >> 4U) | ((uint16_t)buf[7]  << 4U)) & 0x07FFU;
    frame_out->channels[5]  = (((uint16_t)buf[7]  >> 7U) | ((uint16_t)buf[8]  << 1U) | ((uint16_t)buf[9]  << 9U)) & 0x07FFU;
    frame_out->channels[6]  = (((uint16_t)buf[9]  >> 2U) | ((uint16_t)buf[10] << 6U)) & 0x07FFU;
    frame_out->channels[7]  = (((uint16_t)buf[10] >> 5U) | ((uint16_t)buf[11] << 3U)) & 0x07FFU;
    frame_out->channels[8]  = ((uint16_t)buf[12]         | ((uint16_t)buf[13] << 8U)) & 0x07FFU;
    frame_out->channels[9]  = (((uint16_t)buf[13] >> 3U) | ((uint16_t)buf[14] << 5U)) & 0x07FFU;
    frame_out->channels[10] = (((uint16_t)buf[14] >> 6U) | ((uint16_t)buf[15] << 2U) | ((uint16_t)buf[16] << 10U)) & 0x07FFU;
    frame_out->channels[11] = (((uint16_t)buf[16] >> 1U) | ((uint16_t)buf[17] << 7U)) & 0x07FFU;
    frame_out->channels[12] = (((uint16_t)buf[17] >> 4U) | ((uint16_t)buf[18] << 4U)) & 0x07FFU;
    frame_out->channels[13] = (((uint16_t)buf[18] >> 7U) | ((uint16_t)buf[19] << 1U) | ((uint16_t)buf[20] << 9U)) & 0x07FFU;
    frame_out->channels[14] = (((uint16_t)buf[20] >> 2U) | ((uint16_t)buf[21] << 6U)) & 0x07FFU;
    frame_out->channels[15] = (((uint16_t)buf[21] >> 5U) | ((uint16_t)buf[22] << 3U)) & 0x07FFU;
...
static void *rx_thread_func(void *arg)
{
    ...
    while (ctx->rx_running) {
        ...
        if (n < 0) {
            ...
            (void)fprintf(stderr,
                          "sbus_input: RX UART read error: %s\n",
                          strerror(errno));
            break;
        }
