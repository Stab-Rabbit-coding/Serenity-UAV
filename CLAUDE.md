...
-- Node variant placement (v2 · v1 · v1 · v2, nose → tail):  Bay A (CN1/FC1) and Bay E (CN4/FC4) use EMI-hardened -2 capes (Cape-A-2, Cape-B-2) at the CAN FD / RS-485 / 1553B bus termination endpoints.  Bay B (CN2/FC2) and Bay D (CN3/FC3) use standard -1 capes to take full advantage of their direct RMII dual-Ethernet interfaces.  This gives EM-hardened fallback at both bus ends while preserving maximum Ethernet ring throughput through the inner nodes.
