...
- The large fuselage EDF is controlled by a third one.  Each of the 4 fc sbcs can take over for all EDFs. **This EDF is now an optional addition once everything else works. **
