...
_PLACEHOLDERS = [
    ...
    (
        "PTFE-SLEEVE-4MM",
        "structural/PTFE_sleeve_4mm_OD_3mm_ID_52mm.stl",
        "PTFE_sleeve_4mm",
    ),
    # Avionics
    (
        "PB2-I",
        "avionics/PocketBeagle2_Industrial_56x35mm.stl",
        "PocketBeagle2_Industrial",
    ),
    ("Pilot", "avionics/Cape_A2_PCB_55x35mm.stl", "Cape_A2"),
    ("TACCO", "avionics/Cape_B2_PCB_55x35mm.stl", "Cape_B2"),
    ("XCVR-49MHZ-2", "avionics/XCVR_49MHZ2_PCB_55x35mm.stl", "XCVR_49MHZ2"),
    ("Flight Engineer", "avionics/FlightEngineer_PDB_90x65mm.stl", "FlightEngineer_PDB"),
    ...
    ("SKIPPER-FIELD-BATTERY", "power/LiPo_4S_10000mAh_175x64x38mm_GCS.stl", "LiPo_4S_GCS"),
    ...
    (
        "CONDUIT-PTFE",
        "wiring/PTFE_conduit_4mm_OD_3mm_ID_700mm.stl",
        "PTFE_conduit_700mm",
    ),
    ...
    (
        "SKIPPER-ENCLOSURE",
        "gcs/Skipper_enclosure_IP65_145x90x65mm.stl",
        "Skipper_enclosure",
    ),
    ("SKIPPER-PWR-5V-BEC", "gcs/Pololu_D24V50F5_5V5A_BEC.stl", "Pololu_5V5A_BEC"),
    ("SKIPPER-PWR-6V-BEC", "gcs/Pololu_D24V22F6_6V2A_BEC.stl", "Pololu_6V2A_BEC"),
    ("SKIPPER-ANT-915-OMNI", "gcs/Antenna_915MHz_omni_5dBi.stl", "Ant_915_omni"),
    ("SKIPPER-ANT-915-YAGI", "gcs/Antenna_915MHz_Yagi_9dBi.stl", "Ant_915_Yagi"),
    ("SKIPPER-ANT-WIFI-PNL", "gcs/Antenna_5GHz_panel_14dBi.stl", "Ant_5GHz_panel"),
    ("SKIPPER-ANT-49MHZ", "gcs/Antenna_49MHz_whip_940mm.stl", "Ant_49MHz_whip"),
    ("SKIPPER-ANT-ZIGBEE", "gcs/Antenna_2p4GHz_zigbee_rubber_duck.stl", "Ant_2p4GHz_duck"),
    ("SKIPPER-ANT-GPS", "gcs/Antenna_GNSS_patch_ANN_MB00.stl", "Ant_GNSS_patch"),
    ("SKIPPER-GPS-MODULE", "gcs/GPS_module_M10Q_SparkFun.stl", "GPS_M10Q"),
    ("SKIPPER-RF-SPLITTER", "gcs/RF_splitter_915MHz_2way_ZFSC.stl", "RF_splitter_915"),
    ("SKIPPER-GIMBAL-ENC", "gcs/AS5600_encoder_breakout_15x15mm.stl", "AS5600_encoder"),
    ("SKIPPER-GIMBAL-MAG", "gcs/N42_disc_magnet_6x2mm.stl", "N42_magnet"),
    ("SKIPPER-TCA9548A", "gcs/TCA9548A_I2C_mux_breakout.stl", "TCA9548A_mux"),
    ("SKIPPER-BRG-6804", "gcs/B6804_20x32x7mm_gimbal_pan.stl", "B6804_gimbal"),
    ("SKIPPER-TRIPOD", "gcs/Skipper_tripod_antenna_mast.stl", "Skipper_tripod"),
    ...
    ("SKIPPER-FAR-FAN", "faraday/Mal_far_fan_40mm_5V.stl", "Mal_far_fan"),
    ("SKIPPER-FAR-GASKET", "faraday/Mal_far_gasket_470x8x1p5mm.stl", "Mal_far_gasket"),
    ...
    (
        "FOAM-FILL-MIDDLE",
        "foam/Foam_fill_middle_horseshoe_173x69x161mm.stl",
        "Foam_middle_fill",
    ),
    ...
    (
        "VOID-VENT-EXHAUST",
        "foam/Void_vent_exhaust_20x300x20mm.stl",
        "Void_vent_exhaust",
    ),
...
def assemble():
    ...
    for bom_ref, rel_path, label in _PLACEHOLDERS:
        ...
        if obj is None:
            ...
            print(
                f"  [{idx+1:02d}]  {label:<40s}  col={col} row={row}  [{bom_ref}]",
                flush=True,
            )
        idx += 1
    ...
    if missing:
        ...
        print(
            "[placeholders] Run generate_placeholders.py to regenerate missing STLs.",
            flush=True,
        )
