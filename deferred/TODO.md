...
> **Deferred Work (Phase 11+)-scoped view**: it carries only the WBS branches owned by this subsystem,
...
> **Phase 12 (Range-Extender Battery Module)** rides in the cargo bay on the same Jayne hooks/release and adds a `J_BATT2` input to Kaylee — a cruise-range, not hover, enhancement. See the Jayne cross-cutting map in [airframe/TODO.md](../airframe/TODO.md).


## §Phase11 — Aft EDF Integration (Deferred)

*Master:* [`TODO.md` §Phase11](../TODO.md) — 42 open, 0 done at snapshot.
...
*Master:* [`TODO.md` §Phase12](../TODO.md) — 6 open, 0 done at snapshot.
