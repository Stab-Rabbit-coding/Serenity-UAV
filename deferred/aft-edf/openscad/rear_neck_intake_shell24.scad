...
//   - Fix: import the voxel-remeshed solid shell (rear_shell24_repaired.stl,
...
// Bounding box of rear_shell24_repaired.stl after voxel-remesh (1.5 mm pitch):
...
//
// Source STL: rear_shell24_repaired.stl — manifold solid shell generated by
//   repair_shells_for_scad.py (blender voxel-remesh, 1.5 mm pitch, 0 NM edges).
//   STL bounds: X=-246..-105.6, Y=-192.9..-35.4, Z=0..180.7 mm.
//
// Why not use the pre-hollowed rear_shell24_2mm_repaired.stl?
...
module hollow_shell() {
    difference() {
        import("../../thingverse-serenity/files-hollowed-18in/rear_shell24_repaired.stl");
        translate([CX, CY, CZ])
