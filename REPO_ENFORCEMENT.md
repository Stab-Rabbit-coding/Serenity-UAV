...
- Licensing: All outputs are dual-licensed by content type — CERN-OHL-W 2.0 for hardware/CAD/PCB, CC BY-SA 4.0 for documentation/code/scripts/drawings (see `docs/attribution_and_licensing.md`). Include attribution in derivative files and commit messages.
