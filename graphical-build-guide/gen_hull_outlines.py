...
#   This file:
#     Analysis/inspection script.  As of R1 the published primary STLs in
#     airframe/stls/ are stored in hull frame; interpret all coordinates
#     read from those meshes as hull-frame values.
# ============================================================================
"""
...
def build_side_view():
    ...
    path_fuse = silhouette_to_path(hv_f, zt_f, zb_f, h_range, v_range, W, H, M)

    hv_n, zt_n, zb_n = compute_silhouette(nacelle_verts, "x", "z", n_bins=400)
    path_nac = silhouette_to_path(hv_n, zt_n, zb_n, h_range, v_range, W, H, M)
...
def build_front_view():
    ...
    # Full YZ silhouette
    hv_f, zt_f, zb_f = compute_silhouette(
        forward_fuse + forward_nac, "y", "z", n_bins=600
    )
...
if __name__ == "__main__":
    ...
    print()
    print(
        "Done.  Review hull_side.svg / hull_top.svg / hull_front.svg / hull_bottom.svg"
    )
