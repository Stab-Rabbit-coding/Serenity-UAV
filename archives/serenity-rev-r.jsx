 ...
 *
 * Revision R: Naming Finalisation & Flight Engineer PDB Baseline
 *
 * Key changes from Rev Q:
 *   1. Cape-A-2 → Pilot naming finalised at all 4 FC positions.
 *      Cape-B-2 → XO naming finalised at all 4 CN positions.
 *      CAPE-A-2 and CAPE-B-2 KiCad files archived to avionics/kicad/archive/
 *      (2026-06-10); Pilot.* and XO.* are the sole active cape design files.
 *   2. Flight Engineer Power Distribution Board (PDB) added:
 ...
 *   Blender, and FreeCAD artifacts; exceptions: avionics KiCad files, Skipper
