...
- 1 × 120 mm EDF in the rear fuselage compartment — ~3500 g thrust, exhaust straight aft
  **DEFERRED — Phase 11.** Design files in `deferred/aft-edf/`. Physical build deferred until all other
  systems are proven. Without this EDF, nacelle-only T/W ≈ 0.51 (forward flight only; no VTOL hover).
- **Phases 5–10 AUW (no aft EDF hardware):** ~2,768 g
  — aft EDF system (120mm EDF ~400g + 80A ESC ~130g + CF-PETG intake frame ~90g + PETG plenum ~80g
  + nozzle frame ~50g + 8 petals ~40g + servo + wiring ~35g ≈ **~840g deferred**).
  Nacelle-only T/W ≈ 1,822g / 2,768g ≈ **0.66** — forward flight and STOL; not VTOL hover.
- **Phase 11 full-system:** ~3,608 g AUW | Total thrust ~5,322 g | T/W ≈ **1.47** — full VTOL hover.
