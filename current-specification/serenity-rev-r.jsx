 ...
 *
 * Revision R: Naming Finalisation & Kaylee PDB Baseline
 *
 * Key changes from Rev Q:
 *   1. Cape-A-2 → Wash naming finalised at all 4 FC positions.
 *      Cape-B-2 → Zoë naming finalised at all 4 CN positions.
 *      CAPE-A-2 and CAPE-B-2 KiCad files archived to avionics/kicad/archive/
 *      (2026-06-10); Wash.* and Zoë.* are the sole active cape design files.
 *   2. Kaylee Power Distribution Board (PDB) added:
 ...
 *      Kaylee.md design-notes document created.
