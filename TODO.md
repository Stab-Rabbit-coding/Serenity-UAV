...
- [ ] ★ Actuator re-select: multi-turn gearmotor/stepper closed on the…
...
- [ ] ★ WA-R16 — tilt train not self-locking, no holding provision (BLOCKS…
...
- [ ] TILT-CTL-01..06 — tilt control loop open items (TILT_DRIVE_CONTROL_SP…
