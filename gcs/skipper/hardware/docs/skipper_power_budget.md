# Skipper GCS — Field Power Budget
...
Skipper GCS uses two independent power rails in field configuration:
...
| Commo (Tx)               | 5 (idle)    | 220       | 100 mW PA burst during AX.25 Tx |
...
avionics rail.  If a Flight Engineer PDB is not present at the GCS, use a dedicated 6 V BEC.
