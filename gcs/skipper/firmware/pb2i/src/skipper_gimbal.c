/**
 * @file    skipper_gimbal.c
 * @brief   Skipper GCS — antenna tracking gimbal controller implementation.
 *
 ...
 *
 * See skipper_gimbal.h for the API and position convention.
 *
 * Hardware path:
...
static skipper_gimbal_pos_t s_target_pos = {0.0f, 0.0f};
