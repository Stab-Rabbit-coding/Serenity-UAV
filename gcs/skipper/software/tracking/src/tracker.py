"""
tracker.py — Skipper GCS antenna tracking: bearing and elevation calculator.
...
Position convention (matches skipper_gimbal.h):
...
Usage:
    python3 tracker.py [--config skipper_config.yaml]
"""
...
def _parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Skipper GCS antenna tracker")
    parser.add_argument(
        "--config",
        "-c",
        type=Path,
