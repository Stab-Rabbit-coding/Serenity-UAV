...
class TestBearing:
    ...
    def test_due_north(self) -> None:
        ...
        assert approx(target.azimuth_deg, 0.0), (
    ...
    def test_due_east(self) -> None:
        ...
        target   = compute_gimbal_target(gcs, aircraft)
        assert approx(target.azimuth_deg, 90.0), (
    ...
    def test_due_south(self) -> None:
        ...
        assert approx(abs(target.azimuth_deg), 180.0, tol=1.0), (
    ...
    def test_bearing_northeast(self) -> None:
        ...
        target   = compute_gimbal_target(gcs, aircraft)
        assert 0.0 < target.azimuth_deg < 90.0, (
...
class TestElevation:
    ...
    def test_horizontal_same_altitude(self) -> None:
        ...
        target   = compute_gimbal_target(gcs, aircraft)
        assert approx(target.elevation_deg, 0.0, tol=1.0), (
    ...
    def test_aircraft_above(self) -> None:
        ...
        target   = compute_gimbal_target(gcs, aircraft)
        assert 30.0 < target.elevation_deg < 60.0, (
    ...
    def test_aircraft_directly_overhead(self) -> None:
        ...
        target   = compute_gimbal_target(gcs, aircraft)
        assert target.elevation_deg >= 80.0, (
...
class TestEdgeCases:
    ...
    def test_azimuth_range(self) -> None:
        ...
        for gcs, aircraft in positions:
            target = compute_gimbal_target(gcs, aircraft)
            assert -180.0 <= target.azimuth_deg <= 180.0, (
    ...
    def test_elevation_range(self) -> None:
        ...
        for gcs, aircraft in positions:
            target = compute_gimbal_target(gcs, aircraft)
            assert -90.0 <= target.elevation_deg <= 90.0, (
