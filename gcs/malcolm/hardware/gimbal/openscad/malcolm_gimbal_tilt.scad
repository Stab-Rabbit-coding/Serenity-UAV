...
// ===========================================================================
/*
 * malcolm_gimbal_tilt.scad
 * Tilt (elevation) stage for Malcolm GCS directional antenna gimbal
 *
 ...
 *     - Antenna mount plate (from malcolm_gimbal_mount.scad) pivots on a
 ...
 *   openscad -o malcolm_gimbal_tilt.stl malcolm_gimbal_tilt.scad
...
/* ---------------------------------------------------------------------------
 * Base attachment (bolts to pan turret TILT_MOUNT boss from malcolm_gimbal_pan.scad)
 * ---------------------------------------------------------------------------*/
