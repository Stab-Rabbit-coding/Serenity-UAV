...
| **Applied to** | `docs/CARGO_DOOR_GATEWAY_SPEC.md` (D-GW-4 servo-power branch, §3 logic-level VERIFY, §9 RCS valve dynamics), `current-specification/bom_revS.csv` `SERVO-CARGO` / `SERVO-RCS-VALVE`, `docs/POWER_DISTRIBUTION.md` §3.3 |
